...
export function NewClientModal({ open, onOpenChange }: NewClientModalProps) {
  ...
  const handleSubmit = () => {
    if (!name || !skillFile || !coverImage) {
      toast({
        title: 'Campos obrigatórios ausentes',
        description: 'Preencha o Nome, Arquivo de skill e Capa do perfil.',
        variant: 'destructive',
      })
      return
    }
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] flex flex-col bg-[#121212] border-[#171717] font-sans">
        <DialogHeader className="shrink-0">
          ...
          <DialogDescription>
            Cadastre um novo cliente e suas informações de marca.
          </DialogDescription>
        </DialogHeader>
